...
class Settings(BaseSettings):
    ...
    # --- ML Model Paths ---
    # --- ML Model Paths ---
    # Use absolute paths relative to this file to ensure Vercel finds them
    BASE_DIR: str = os.path.dirname(os.path.abspath(__file__))
    CLASSIFICATION_PIPELINE: str = os.path.join(BASE_DIR, "models", "case_classification", "voting_pipeline.pkl")
    CLASSIFICATION_ENCODER: str = os.path.join(BASE_DIR, "models", "case_classification", "label_encoder.pkl")
    PRIORITIZATION_PIPELINE: str = os.path.join(BASE_DIR, "models", "case_prioritization", "stacking_pipeline.pkl")
    PRIORITIZATION_ENCODER: str = os.path.join(BASE_DIR, "models", "case_prioritization", "label_encoder.pkl")
